    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white">
      <div className="container mx-auto px-4 py-16 max-w-4xl">
        ...
        <div className="glass rounded-xl p-8 space-y-6">
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-purple-300">1. Scope</h2>
            <p className="text-gray-300 leading-relaxed">
              These terms of service apply to the use of the chat application on this subdomain of lukeschroeter.de. 
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-purple-300">3. Bring-Your-Own-Key Model</h2>
            <p className="text-gray-300 leading-relaxed mb-3">
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-purple-300">4. Registration and User Account</h2>
            <p className="text-gray-300 leading-relaxed mb-3">
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-purple-300">5. Permitted Use</h2>
            <p className="text-gray-300 leading-relaxed mb-3">
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-purple-300">6. Privacy and Storage</h2>
            <p className="text-gray-300 leading-relaxed mb-3">
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-purple-300">7. Availability</h2>
            <p className="text-gray-300 leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-purple-300">10. Changes</h2>
            <p className="text-gray-300 leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-purple-300">11. Final Provisions</h2>
            <p className="text-gray-300 leading-relaxed">
