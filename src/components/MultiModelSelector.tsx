...
import { getFilteredModels, getModelFilteringContext, getUserModeDescription } from '@/lib/modelFiltering';
...
export function MultiModelSelector({ 
  ...
  // Get user context for model filtering
  const { isGuest, profile } = useChat();
